	...
	THUMB_FUNC_START sub_807ACBC
sub_807ACBC: @ 0x0807ACBC
	push {r4, r5, r6, r7, lr}
	adds r7, r0, #0
	adds r5, r1, #0
	ldr r6, _0807ACE4
	...
	b _0807AD02
	.align 2, 0
_0807ACE4: .4byte gUnknown_03006560
_0807ACE8:
	adds r0, r6, #0
	adds r1, r4, #0
	bl sub_807B1B0
...
_0807AD02:
	...
	THUMB_FUNC_START sub_807AD04
sub_807AD04: @ 0x0807AD04
	push {lr}
	adds r1, r0, #0
	ldr r0, _0807AD10
	bl sub_807B030
	pop {pc}
	.align 2, 0
_0807AD10: .4byte gUnknown_03006560

	THUMB_FUNC_START sub_807AD14
sub_807AD14: @ 0x0807AD14
	push {lr}
	ldr r0, _0807AD24
	bl sub_807B0DC
	bl sub_807AD04
	pop {pc}
	.align 2, 0
_0807AD24: .4byte gUnknown_03006560
...
_0807ADA0: .4byte 0x04000004
	...
	THUMB_FUNC_START sub_807ADA4
sub_807ADA4: @ 0x0807ADA4
	push {lr}
	bl sub_807AD28
	bl sub_807AD90
	pop {pc}
...
sub_807ADB4: @ 0x0807ADB4
	...
	pop {r4, pc}
	.align 2, 0
_0807ADDC: .4byte gUnknown_0827D308
_0807ADE0: .4byte gUnknown_03006630
_0807ADE4: .4byte intr_main
_0807ADE8: .4byte gUnknown_03000718
_0807ADEC: .4byte gUnknown_03007FFC
